...
val MIGRATION_1_2 = object : Migration(1, 2) {
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        // FAQ
        database.execSQL("INSERT INTO faq VALUES('Booking')")
        database.execSQL("INSERT INTO faq VALUES('Additional Fees')")
        database.execSQL("INSERT INTO faq VALUES('Refund Policy)'")

        // Question
        database.execSQL("INSERT INTO questions(faqQuestionId, questionId, question, answer) VALUES(1, 1, 'How do I make an order via UbayaKost?', " +
                "'Download the UbayaKost app, then Choose the kost that suits your needs, and click booking.')")
        database.execSQL("INSERT INTO questions(faqId, id, question, answer) VALUES(1, 2, 'I am not experienced in booking accommodation online. Is there any help available to me?', " +
                "'For questions or other information, please contact us via email.')")
        database.execSQL("INSERT INTO questions(faqId, id, question, answer) VALUES(2, 1, 'Are there any additional fees I have to pay?', " +
        ...
        database.execSQL("INSERT INTO questions(faqId, id, question, answer) VALUES(2, 2, 'Are there any additional fees I have to pay?', " +
                "'You are only required to pay an additional fee if you use additional facilities or services provided by the accommodation where you are staying. In this case, additional costs are paid directly to the accommodation.')")
        database.execSQL("INSERT INTO questions(faqId, id, question, answer) VALUES(3, 1, 'When will UbayaKost refund my payment when my order is not finally confirmed?', " +
        ...
        database.execSQL("INSERT INTO questions(faqId, id, question, answer) VALUES(3, 2, 'When will UbayaKost refund the deposit payment?', " +
