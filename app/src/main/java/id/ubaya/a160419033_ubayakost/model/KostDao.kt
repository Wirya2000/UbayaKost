...
interface KostDao {
    ...
    @Query("INSERT INTO kost(kostId,name, gender, region, price, photoUrl, alamat, fasilitas, peraturan, x, y)" +
            " VALUES(1, 'Kost Apik UBAYA Si Mbok', 'Putra', 'Rungkut', '1.377.000'," +
    ...
    suspend fun insert1()
    @Query("INSERT INTO kost(kostId,name, gender, region, price, photoUrl, alamat, fasilitas, peraturan, x, y)" +
            "VALUES(2, 'Kost RMS 145PR', 'Putra', 'Rungkut', '1.200.000'," +
    ...
    suspend fun insert2()
    @Query("INSERT INTO kost(kostId,name, gender, region, price, photoUrl, alamat, fasilitas, peraturan, x, y)" +
            "VALUES(3, 'Kost Gaia 2', 'Putri', 'Rungkut', '1.750.000', " +
    ...
    suspend fun insert3()
    @Query("INSERT INTO kost('kostId','name', 'gender', 'region', 'price', 'photoUrl', 'alamat', 'fasilitas', 'peraturan', 'x', 'y')" +
            "VALUES(4, 'Kost Singgahsini Q Sidosermo', 'Campur', 'Kecamatan Wonocolo', '2.020.000', " +
